...
# 1. extract tabulate to libs/tabulate
set(TABULATE_SOURCE_DIR "${CMAKE_SOURCE_DIR}/libs/tabulate")

# Prepare tabulate for use in the main project
set(TABULATE_INCLUDE_DIR ${TABULATE_SOURCE_DIR}/include)
...
target_include_directories(tabulate INTERFACE ${TABULATE_INCLUDE_DIR})