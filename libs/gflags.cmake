...
# 1. Extract gflags to libs/gflags
set(GFLAGS_SOURCE_DIR "${CMAKE_SOURCE_DIR}/libs/gflags")
set(GFLAGS_BUILD_DIR "${GFLAGS_SOURCE_DIR}/build")

# Prepare gflags
set(GFLAGS_INCLUDE_DIR ${GFLAGS_BUILD_DIR}/include)
set(GFLAGS_LIBRARY_PATH ${GFLAGS_BUILD_DIR}/lib/libgflags.a)
file(MAKE_DIRECTORY ${GFLAGS_INCLUDE_DIR})
add_library(gflags STATIC IMPORTED)
set_property(TARGET gflags PROPERTY IMPORTED_LOCATION ${GFLAGS_LIBRARY_PATH})
set_property(TARGET gflags APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${GFLAGS_INCLUDE_DIR})
...
add_subdirectory(${GFLAGS_SOURCE_DIR} ${GFLAGS_BUILD_DIR})
