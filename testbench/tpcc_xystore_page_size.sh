...
tpcc_ExdIndex2() {
    for page_size in 4 8 16; do
        ...
        numactl -N 0 sudo ../build/frontend/xystore_tpcc \
            ...
            --xmerge \
            --print_tx_console \
            --run_for_seconds=600 >../results/tpcc/data/tpcc_IndeX_${underlying_storage}_30GB_8_thrd_${page_size}KB_page_2TX_pg.data

        mv log.log ../results/tpcc/data/tpcc_IndeX_${underlying_storage}_30GB_8_thrd_${page_size}KB_page_2TX_pg.log
    done
}
